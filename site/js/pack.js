...
function bubbleClick(d) {
    switch (d.level) {
        case "genre":
            ...
            window.location.href = "pack.html?" + "genre=" + d.slug;
            break;
        case "style":
            // Create a link going to the decade level
            window.location.href = "pack.html?" + "genre=" + genreParam + "&" + "style=" + d.slug;
            break;
        case "decade":
            // Create a link going to the album level
            window.location.href = "pack.html?" + "genre=" + genreParam + "&" + "style=" + styleParam + "&" + "decade=" + d.name;
            break;
        default:
